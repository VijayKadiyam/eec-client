          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">
                ...
                Inspector ({{ inspector.first_name }} {{ inspector.last_name }}) Vaccinations</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Edit Inspector Vaccination Details</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
...
export default {
  ...
  async asyncData({$axios, params}) {
    ...
    let vaccination = await $axios.get(`/users/${params.employeeId}/vaccinations/${params.id}`)
    return {
      inspector: inspector.data.data,
      form: vaccination.data.data
    }
  },
  components: {
    BackButton
