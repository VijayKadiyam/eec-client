    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Inspector ({{ inspector.first_name }} {{ inspector.last_name }}) Relations</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Add Inspector Relation Details</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
                  ...
                  <div class="form-footer">
                    <button class="btn btn-primary btn-block"
                      @click="store"
                    >Create Inspector Relation</button>
                  </div>
                </div>
              </div>
              <!-- /.card -->
...
export default {
  ...
  methods: {
    async store() {
      try {
        await this.$axios.post(`/users/${this.$route.params.employeeId}/relations`, this.form)
