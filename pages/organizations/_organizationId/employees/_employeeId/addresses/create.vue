          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">
                ...
                Inspector ({{ inspector.first_name }} {{ inspector.last_name }}) Addresses</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Add Inspector address</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
    ...
    getLatLngFromAddress() {
      this.$gmapApiPromiseLazy().then(() => {
        ...
        geocoder.geocode({ address }, async function (results, status) {
          ...
          try {
            await _this.$axios.post(`/users/${_this.$route.params.employeeId}/addresses`, _this.form)
