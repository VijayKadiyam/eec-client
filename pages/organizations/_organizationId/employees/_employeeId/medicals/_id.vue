    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Inspector ({{ inspector.first_name }} {{ inspector.last_name }}) Medicals</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Edit Inspector Medical Details</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
                  ...
                  <div class="form-footer">
                    <button class="btn btn-primary btn-block"
                      @click="store"
                    >Update Inspector Medical Details</button>
                  </div>
                </div>
              </div>
              <!-- /.card -->
...
export default {
  ...
  async asyncData({$axios, params}) {
    ...
    let medical = await $axios.get(`/users/${params.employeeId}/medicals/${params.id}`)
    return {
      inspector: inspector.data.data,
      form: medical.data.data
    }
  },
  methods: {
    async store() {
