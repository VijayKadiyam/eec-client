...
export default {
  ...
  async asyncData({$axios, params}) {
    ...
    let medical = await $axios.get(`/users/${params.employeeId}/medical_details/${params.id}`)
    return {
  ...
  methods: {
    async store() {
      try {
        await this.$axios.patch(`/users/${this.$route.params.employeeId}/medical_details/${this.$route.params.id}`, this.form)
