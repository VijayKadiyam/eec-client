    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Inspector ({{ inspector.first_name }} {{ inspector.last_name }}) | Emergency Contact: {{ form.first_name }} {{ form.last_name }}</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
export default {
  ...
  async asyncData({$axios, params}) {
    ...
    let emergency = await $axios.get(`/users/${params.employeeId}/emergencies/${params.id}`)
    return {
      inspector: inspector.data.data,
      form: emergency.data.data
    }
  },
  mounted() {
    this.form.role_id = 3;
  ...
  methods: {
    async store() {
      try {
        await this.$axios.patch(`/users/${this.$route.params.employeeId}/emergencies/${this.$route.params.id}`, this.form)
