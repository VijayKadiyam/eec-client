          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">
                ...
                Inspector ({{ inspector.first_name }} {{ inspector.last_name }}) Professional Courses</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Edit Inspector Professional Course Details</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
                  ...
                  <div class="form-footer">
                    <button class="btn btn-primary btn-block"
                      @click="store"
                    >Update Inspector Professional Course Details</button>
                  </div>
                </div>
              </div>
              <!-- /.card -->
...
export default {
  ...
  async asyncData({$axios, params}) {
    ...
    let professional_course = await $axios.get(`/users/${params.employeeId}/professional_courses/${params.id}`)
    return {
      inspector: inspector.data.data,
      form: professional_course.data.data
    }
  },
  data: () => ({
    form: {
  ...
  methods: {
    async store() {
      try {
        await this.$axios.patch(`/users/${this.$route.params.employeeId}/professional_courses/${this.$route.params.id}`, this.form)
