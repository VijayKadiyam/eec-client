            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Manage Campaigns</h3> &nbsp;
                  <nuxt-link class="btn btn-sm btn-info float-sm-right" :to="`/organizations/${organization.value}/campaigns/create`">Add New</nuxt-link>
                </div>
                <!-- /.card-header -->
                  ...
                  <table class="table table-head-fixed table-striped">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="w-1">
                          <nuxt-link title="Edit Details" class="icon" :to="`/organizations/${organization.value}/campaigns/${item.id}`">
...
export default {
  ...
  methods: {
    async getData() {
      this.items = []
      this.loading = true
      let items = await this.$axios.get(`/campaigns`)
