    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Screenings</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Manage Screenings</h3> &nbsp;
                  <nuxt-link class="btn btn-sm btn-info float-sm-right" :to="`/organizations/${organization.value}/screenings/create`">Add New</nuxt-link>
                </div>
                <!-- /.card-header -->
                  ...
                  <table class="table table-head-fixed table-striped">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="w-1">
                          <nuxt-link title="Edit Details" class="icon" :to="`/organizations/${organization.value}/screenings/${item.id}`">
...
export default {
  ...
  methods: {
    async getData() {
      this.items = []
      this.loading = true
      let items = await this.$axios.get(`/screenings`)
    ...
    async del(id) {
      ...
      if(r)
        await this.$axios.delete(`/screenings/${id}`)
      this.getData()
    },
    sort(s) {
