    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Circular Details</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Edit Circular Details</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
                  ...
                  <div class="form-footer">
                    <button class="btn btn-primary btn-block"
                      ...
                      :disabled="loading"
                    >
                      {{ loading ? 'Saving...' : 'Update Circular' }}
                    </button>
                  </div>
                </div>
              </div>
...
export default {
  ...
  async asyncData({$axios, params}) {
    let circular = await $axios.get(`/circulars/${params.id}`)
    return {
  ...
  methods: {
    async store() {
      this.loading = true
      try {
        let admin = await this.$axios.patch(`/circulars/${this.$route.params.id}`, this.form)
