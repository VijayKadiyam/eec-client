          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">
                <back-button
                  :link="`/organizations/${organization.value}/manuals`"
                  title="Hi"
                >
                </back-button>
                Manuals Details
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                  <nuxt-link :to="`/organizations/${this.organization.value}/manuals`">Manuals</nuxt-link>
                </li>
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Edit Manuals Details</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Manual name"
                      v-model="form.name"
                    >
...
export default {
  ...
  async asyncData({$axios, params}) {
    let circular = await $axios.get(`/manuals/${params.id}`)
    return {
