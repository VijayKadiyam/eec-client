            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <nuxt-link class="btn btn-sm btn-info" :to="`/organizations/${organization.value}/procedures/create`">Add New</nuxt-link>
                </div>
                <!-- /.card-header -->
                  ...
                  <table class="table table-head-fixed table-striped">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="w-1">
                          <nuxt-link class="icon" :to="`/organizations/${organization.value}/procedures/${item.id}`">
