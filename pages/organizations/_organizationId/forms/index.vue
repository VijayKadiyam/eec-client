            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <nuxt-link class="btn btn-sm btn-info float-sm-right" :to="`/organizations/${organization.value}/forms/create`">Add New</nuxt-link>
                </div>
                <!-- /.card-header -->
                  ...
                  <table class="table table-head-fixed table-striped">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="w-1">
                          <nuxt-link title="Edit Details" class="icon" :to="`/organizations/${organization.value}/forms/${item.id}`">
...
export default {
  ...
  methods: {
    async getData() {
      this.items = []
      this.loading = true
      let items = await this.$axios.get(`/forms`)
